package dk.rohdef.gourmet

import arrow.core.Either
import arrow.core.continuations.either
import arrow.core.left
import arrow.core.right
import dk.rohdef.gourmet.generateScript.generateRunScript
import io.ktor.util.*
import kotlinx.coroutines.runBlocking
import mu.KotlinLogging
import dk.rohdef.gourmet.runRecipe.runRecipe
...
suspend fun generateScript(cliArguments: Array<String>) {
    ...
    generateRunScript(OkioPathUtility.createPathUtilityUnsafe())
}